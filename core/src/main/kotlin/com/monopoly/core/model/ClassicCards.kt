...
/**
 * The standard Chance and Community Chest decks.
 *
...
object ClassicCards {
    ...
    val chance: List<Card> = listOf(
        ...
        Card("ch_illinois", "Advance to Illinois Avenue. If you pass GO, collect \$200.",
            CardEffect.AdvanceTo(24)),
        Card("ch_st_charles", "Advance to St. Charles Place. If you pass GO, collect \$200.",
        ...
        Card("ch_nearest_rail_1", "Advance to the nearest Railroad. Pay the owner twice the usual rent.",
            CardEffect.AdvanceToNearest(CardEffect.AdvanceToNearest.Kind.RAILROAD, rentMultiplier = 2)),
        Card("ch_nearest_rail_2", "Advance to the nearest Railroad. Pay the owner twice the usual rent.",
            CardEffect.AdvanceToNearest(CardEffect.AdvanceToNearest.Kind.RAILROAD, rentMultiplier = 2)),
        ...
        Card("ch_reading", "Take a trip to Reading Railroad. If you pass GO, collect \$200.",
            CardEffect.AdvanceTo(5)),
        Card("ch_boardwalk", "Take a walk on the Boardwalk. Advance to Boardwalk.",
    ...
    val communityChest: List<Card> = listOf(
        ...
        Card("cc_go_to_jail", "Go directly to Jail. Do not pass GO, do not collect \$200.",
            CardEffect.GoToJail),
        Card("cc_holiday", "Holiday fund matures. Receive \$100.",
